...
output_dir = r'c:\Users\zined\Documents\GitHub\bisbis naw\the_word_of_words\scratch\all_extracted'
    ...
    try:
        ...
        for i in range(len(doc)):
            ...
            for img_index, img in enumerate(img_list):
                ...
                # Save as PNG
                filename = f"{pdf_name.replace('.pdf', '')}_page{i}_img{img_index}.png"
